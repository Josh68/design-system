...
import ThemeContent from '../../components/ThemeContent.tsx';
...
<ThemeContent client:load onlyThemes={['core']}>
...
<ThemeContent client:load onlyThemes={['healthcare']}>
...
<ThemeContent client:load onlyThemes={['medicare']}>
